...
echo <<<OUT
	...
	<p>你可以调整设置下面的“虚拟浏览器”。这些选项影响代理发送到目标服务器的信息。</p>
	<form action="includes/process.php?action=edit-browser" method="post">
		...
		<table cellpadding="2" cellspacing="0" align="center" class="large-table">
			...
			<tr>
				<td colspan="2" class="small-note"><b>注意:</b> 一些网站根据你的用户代理可能调整内容.</td>
			</tr>
		</table>

		<table cellpadding="2" cellspacing="0" align="center" class="large-table">
			<tr>
				<th colspan="2">页面来源 (<a style="cursor:help;" onmouseover="tooltip('The URL of the referring page is normally sent to the server. You can override this to a custom value or set to send no referrer for extra privacy.')" onmouseout="exit()">?</a>)</th>
			</tr>
			<tr>
				<td width="150">发送真实来源页面:</td>
			...
			<tr>
				<td colspan="2" class="small-note"><b>注意:</b> 一些网站会验证你的来源地址,如果设置为拒绝访问可能会影响你正确访问</td>
			</tr>
		</table>
